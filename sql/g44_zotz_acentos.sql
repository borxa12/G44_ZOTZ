...
INSERT INTO `establecimiento` (`usuarios_login`, `nombre`, `direccion`, `telefono`, `web`, `horario`, `descripcionestablecimiento`) VALUES('centolo', 'O Centolo', 'Avd/Mar nº9', '988213366', 'www.centolo.com', '13.00-24.00', 'Especialidades de la casa: pulpo, marisco y bacalao');
...
INSERT INTO `establecimiento` (`usuarios_login`, `nombre`, `direccion`, `telefono`, `web`, `horario`, `descripcionestablecimiento`) VALUES('elplato', 'El Plato', 'c/Manzana nº9', '988541136', 'www.el-plato.com', '13.00-24.00', 'M&uacute;sica en directo durante la cena');
...
INSERT INTO `juradoprofesional` (`usuarios_login`,`fotojuradoprofesional`,`nombrejuradoprofesional`,`reconocimientos`) VALUES('maria','maria.jpg','Mar&iacute;a P&eacute;rez L&oacute;pez','Mejor repostera del a&ntilde;o 2013 y finalista al bogabante de oro en el a&ntilde;o 2014');
