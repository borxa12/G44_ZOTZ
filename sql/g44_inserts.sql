...
INSERT INTO `juraprofesional` (`usuarios_login`,`fotojuradoprofesional`,`nombrejuradoprofesional`,`reconocimientos`) VALUES('mariano','mariano.jpg','Mariano Sousas Fernández','Nombrado tres veces estrella Michelin por sus grandes obras gastronómicas');
INSERT INTO `juraprofesional` (`usuarios_login`,`fotojuradoprofesional`,`nombrejuradoprofesional`,`reconocimientos`) VALUES('maria','maria.jpg','María Pérez López','Mejor repostera del año 2013 y finalista al bogabante de oro en el año 2014');
INSERT INTO `juraprofesional` (`usuarios_login`,`fotojuradoprofesional`,`nombrejuradoprofesional`,`reconocimientos`) VALUES('paloma','paloma.jpg','Paloma Fernández Álvarez','Nombrada finalista tres años consecutivos (2010-2013) y ganadora en el año 2014 de los premios Restaurante de Oro');
INSERT INTO `juraprofesional` (`usuarios_login`,`fotojuradoprofesional`,`nombrejuradoprofesional`,`reconocimientos`) VALUES('jose','jose.jpg','Jose Méndez Castro','Mejor pincho en el certamen de pinchos de Madrid en el año 2014');
INSERT INTO `juraprofesional` (`usuarios_login`,`fotojuradoprofesional`,`nombrejuradoprofesional`,`reconocimientos`) VALUES('alberto','alberto.jpg','Alberto Domínguez Pereira','Maestro cocinero reconocido internacionalmente por la revista Kitchen');

-- Insertar Pincho

INSERT INTO `pincho` (`idpincho`, `nombrepincho`, `fotopincho`, `descripcionpincho`, `ingredientesp`, `precio`, `aceptado`, `concurso_edicion`, `establecimiento_usuarios_login`) VALUES(1, 'Delicia de salmon', '1_3_centolo.jpg', 'Salmon ahumado sobre pan tostado', 'Salmon ahumado, pan tostado', '2.5', 'A', 3, 'centolo');
