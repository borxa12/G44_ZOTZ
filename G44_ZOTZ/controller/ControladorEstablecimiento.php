<?php
    ...
    */
	...
	/* Lista los pinchos para un establecimiento
    *  Parámetros:
    *       $login - Login del establecimiento del que se quieren listar los pinchos
    *  Return: Devuelve una lista de pinchos
	*/
	...
	*	Parámetros
	*		$edicion - Edición del concurso para la que se quiere comprobar los pinchos registrados por el establecimiento.
	*		$est - Establecimiento del que se quiere comprobar los pinchos registrados. Es el login del establecimiento.
