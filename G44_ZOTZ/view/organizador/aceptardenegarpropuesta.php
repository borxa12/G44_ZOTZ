...
?>
    <div>
		<h1>Propostas Gastronómicas</h1>
		<?php
    		echo "<h4>Nome: ".$fila["nombrepincho"]."</h4>";
    		echo "<h4>Ingredientes: ".$fila["ingredientesp"]."</h4>";
    		echo "<h4>Descrición: ".$fila["descripcionpincho"]."</h4>";
    		echo "<h4>Prezo: ".$fila["precio"]."</h4>";
            echo "<div class=''>";
            echo "<h4> Foto: </h4>";
    	...
    	<div class="button">
    		...
    		<button type="submit" formaction="propuestasgastronomicas.php" name="Denegar" class="btn btn-default button">Rexeitar</button>
    		</form>
    	</div>
	</div>
