...
?>
				...
				<div id=templatemo_form>
					...
					<form id="votojuradopopular" method="post">
						<div>
							<label>Código 1</label> <input name="cod1" type="text"/>
							<br></br>
						</div>
						<div>
							<label>Código 2</label> <input name="cod2" type="text" />
							<br></br>
						</div>
						<div>
							<label>Código 3</label> <input name="cod3" type="text" />
							<br></br>
						</div>
					...
					<?php
									if($id1!=$id2 && $id3!=$id2){
										...
										echo '<script> alert("Os c\u00f3digos deben ser de pinchos diferentes");</script>';
										echo '<script> window.location="./votarjuradopopular.php";</script>';
									}
								}else {
									echo '<script> alert("Alg\u00fan c\u00f3digo non é v\u00e1lido");</script>';
						            echo '<script> window.location="./votarjuradopopular.php";</script>';
						        }
   							}
   					?>
