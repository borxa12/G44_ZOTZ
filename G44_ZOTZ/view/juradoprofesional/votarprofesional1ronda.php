...
<h1>Lista de pinchos asignados</h1>

<?php
    $pinchos = listar1Ronda($_SESSION['login']);
    if(mysqli_num_rows($pinchos) == 0) {
        ...
        while($r = mysqli_fetch_assoc($pinchos)) {
            ...
            echo "<div class='product_box'>";
                ...
                echo "</p>";
                echo "<form name='btnverpincho' method='post' action='./votopincho1ronda.php?pincho=".$data['idpincho']."'>";
