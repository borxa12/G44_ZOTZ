...
echo "<img onclick='javascript:this.width=720;this.height=438' ondblclick='javascript:this.width=200;this.height=180' src='../../img/gastromapa/".$r['gastromapa']."' alt='O Gastromapa non está dispoñible' width='100'</img>";
echo '<div>';
