...
-- -----------------------------------------------------
-- Table `G44_ZOTZ`.`comentarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `G44_ZOTZ`.`comentarios` (
  `pincho_idpincho` INT NOT NULL,
  `usuarios_login` VARCHAR(20) NOT NULL,
  `fecha` DATETIME NOT NULL,
  `comentario` MEDIUMTEXT NOT NULL,
  PRIMARY KEY (`pincho_idpincho`, `usuarios_login`, `fecha`),
  INDEX `fk_pincho_has_usuarios_usuarios1_idx` (`usuarios_login` ASC),
  INDEX `fk_pincho_has_usuarios_pincho1_idx` (`pincho_idpincho` ASC),
  CONSTRAINT `fk_pincho_has_usuarios_pincho1`
    FOREIGN KEY (`pincho_idpincho`)
    REFERENCES `G44_ZOTZ`.`pincho` (`idpincho`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pincho_has_usuarios_usuarios1`
    FOREIGN KEY (`usuarios_login`)
    REFERENCES `G44_ZOTZ`.`usuarios` (`login`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
