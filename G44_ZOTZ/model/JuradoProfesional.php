<?php
    class JuradoProfesional {
        ...
        */
        ...
        /*	Lista los miembros del jurado profesionalque no han sido asignados a un pincho determinado.
        *   Parametros:
        *        $id - id del pincho del que se quieren recuperar los miembros no asignados.
        *   Return: Devuelve una lista con los datos de los miembros del jurado profesional que no se han asignado al pincho ($id).
        */
